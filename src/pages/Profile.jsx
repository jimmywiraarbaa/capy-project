  ...
  return (
    <div>
      <div className="static">
        <div className="flex pt-19 pb-80 bg-black justify-center items-center static mb-96">
          <img
        ...
        >
          ...
          <div className="flex items-center max-sm:flex-col ">
            {/* Nav Ikon */}
            <div
              className="flex border drop-shadow-lg rounded-xl mr-28 ml-20 max-sm:mr-0 max-sm:ml-0 max-sm:mb-10"
              style={{ boxShadow: "2px 2px 4px rgba(0, 0, 0, 0.4)" }}
            >
            ...
            <div className="flex justify-center max-sm:order-2 max-sm:mb-6">
              <div className="flex relative w-44 h-44  justify-center items-center m-1 mr-2 text-xl rounded-full ml-7">
