        ...
        <div>
            <div className="flex flex-col justify-center h-screen items-center bg-black overflow-hidden">
                <div className="bg-white w-2/4 py-14 rounded-3xl px-8 max-sm:w-auto">
                    <h1 className="text-center text-2xl font-bold mb-8 animate-wiggle-more animate-infinite max-sm:text-base ">Selamat Datang Kembali</h1>
                    ...
                    <form action="">
                        <div className="flex flex-col mb-5 drop-shadow-xl">
                            ...
                            <input className="rounded-2xl animate-spin" type="text" />
                        </div>

                        <div className="flex flex-col mb-3 drop-shadow-xl">
                            <label className="mb-3 max-sm:text-xs" htmlFor="">Kata sandi</label>
                            <input className="rounded-2xl animate-spin animate-infinite animate-reverse" type="password" />
                        </div>
                        <Link className="text-blue-400 underline underline-offset-4 max-sm:text-xs" to={'forgot-password'}>Lupa password?</Link>

                        <div className="mt-8 w-auto">
                            <button className="bg-black text-yellow-300 rounded-2xl w-full py-3 animate-spin text-xl max-sm:text-xs" type="submit">Daftar</button>
                        </div>
                    </form>
